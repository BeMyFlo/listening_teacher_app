...
- **`path/to/file.js:42`** [bug] — Brief description
  > Recommendation: How to fix

### High

- **`path/to/file.js:26`** [bug] — Brief description
  > Recommendation: How to fix

### Medium

- **`path/to/file.js:88`** [performance] — Brief description
...
```json
{
  "rules": [
    {
      "path": "**/*.js",
      "rule": "All API handlers must validate required parameters",
...
```bash
ocr rules check app/api/lessons/route.js
```
...
- **Comment language follows config** — the `language` config controls review comment language, defaults to `English`, and accepts any language name (for example `English`, `Tiếng Việt` or `中文`).
