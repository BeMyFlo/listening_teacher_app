...
async function emit({ studentId, type, dedupeKey, unitId, submissionId, title, body, dueAt }) {
  if (!studentId || !type || !dedupeKey) {
    throw new Error("emit: studentId, type, dedupeKey are required");
  }
