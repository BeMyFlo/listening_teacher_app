...
function renderHtml(notif, recipientName) {
  ...
  const linkHtml =
    linkPath && APP_URL
      ? `<p style="margin:24px 0 0"><a href="${APP_URL}${linkPath}" style="background:#3D97D6;color:#fff;padding:10px 18px;border-radius:6px;text-decoration:none;display:inline-block">Open</a></p>`
      : "";
