...
// role "teacher"
// workspaceId tuỳ chọn: tạo giáo viên "đúng nghĩa" còn phải tạo Workspace +
// WorkspaceMember (Phase 5), nên ở đây chỉ nhận nếu chỗ gọi đã có sẵn.
...
// role "student"
// workspaceId BẮT BUỘC: thiếu thì tài khoản tạo ra đăng nhập được nhưng 403
// mọi màn hình (lib/tenant.js currentWorkspace -> null -> withTenant 403) —
// từ chối tạo còn hơn tạo ra một tài khoản chết.
