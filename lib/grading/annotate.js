...
function pick(a) {
  return { id: a.id, start: a.start, end: a.end, action: a.action, category: a.category, criterion: a.criterion, comment: a.comment, insertText: a.insertText, source: a.source };
}
