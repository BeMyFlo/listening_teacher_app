...
// Như requireRole nhưng chấp nhận nhiều vai trò (vd endpoint dùng chung cho
// cả teacher lẫn student). req.auth.role cho biết ai đang gọi.
...
module.exports = { signToken, signTeacherToken, signStudentToken, signUserToken, getSecret, requireRole, requireAnyRole, requireAuth, requireTeacher, requireStudent };
