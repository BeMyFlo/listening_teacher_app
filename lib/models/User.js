...
// Partial (không phải sparse) — vì teacherId/studentId có default:null, sparse sẽ
// coi mọi null là "có giá trị" và đụng unique. Partial chỉ ràng buộc khi là ObjectId.
UserSchema.index(
  { teacherId: 1 },
