...
const SubmissionSchema = new mongoose.Schema({
  ...
  // "ai_draft" = AI đã chấm, đang chờ giáo viên duyệt; học sinh CHƯA thấy điểm
  // (mọi chỗ phía học sinh chỉ coi "graded" là đã chấm).
  gradingStatus: { type: String, enum: ["submitted", "ai_draft", "graded"], default: "submitted" },
