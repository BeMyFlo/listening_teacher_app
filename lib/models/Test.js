...
// audioId / imageId works no matter which API route loads Test first.
require("./Audio");
require("./Image");
...
const TestSchema = new mongoose.Schema(
  {
    ...
    // Lớp được gán làm bài này. [] = mọi học sinh đúng level đều thấy.
...
TestSchema.index({ workspaceId: 1, status: 1, level: 1 });
