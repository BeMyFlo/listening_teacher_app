...
const AiLogSchema = new mongoose.Schema({
  ...
  // Tiền ước tính (USD) theo bảng giá lúc gọi. priced=false: model không có
  // trong bảng giá, đang tính theo giá cao nhất.
  costUsd: { type: Number, default: 0 },
  priced: { type: Boolean, default: true },
  // true = không gọi LLM vì đã hết giới hạn tiền tháng này.
